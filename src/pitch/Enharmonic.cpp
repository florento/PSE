...
enum NoteName Enharmonics::name(int c, int i, bool cf, bool da)
{
    ...
    assert(i <= 2);
    if (cf and da)
        return ENHARMONIC1b[c][i].name;
    else if (cf)
        return ENHARMONICb[c][i].name;
    else if (da)
        return ENHARMONIC1[c][i].name;
    else
...
enum Accid Enharmonics::accid(int c, int i, bool cf, bool da)
{
    ...
    assert(i <= 2);
    if (cf and da)
        return ENHARMONIC1b[c][i].alteration;
    else if (cf)
        return ENHARMONICb[c][i].alteration;
    else if (da)
        return ENHARMONIC1[c][i].alteration;
    else
